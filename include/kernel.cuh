...
__global__ void mainKernel(float* posx, float* posy, float* posz, float* dirx, float* diry, float* dirz, float* step, double* grid, const uint* gridSize, const double* voxelSize, curandState* randState) {
